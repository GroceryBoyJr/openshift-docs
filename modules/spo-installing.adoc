...
[role="_abstract"]
You can use the {product-title} web console to install the Security Profiles Operator. This installs the Security Profiles Operator into the `openshift-security-profiles` namespace by default. You can also verify correct installation using the {product-title} web console.
