...
[role="_abstract"]
You can install the {product-title} Security Profiles Operator using the command line interface. This process is shown here along with example YAML files to enable installation. In this example, the namespace is created during the installation process and the installation is verified.
